...
{{ $post->links() }}
@foreach($piechartmonthly as $piechart)
...
<canvas id="barchartid" style="width:50%;max-width:600px"></canvas>-->
         ...
         <div class="card card-info">
              <div class="card-header">
                <h3 class="card-title">Monthly Sales Quantity </h3>
        ...
        <canvas id="myChart" style="min-height: 250px; height: 400px; max-height: 400px; max-width: 100%;"></canvas>     
          ...
          <div class="col-md-6">
              ...
              <div class="card-header">
                <h3 class="card-title">Monthly Sales Profit</h3>
         ...
         <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Monthly Loss</h3>
