  ...
  data-show-columns="true">
    ...
    @foreach($post as $posts)
        <tr>
                ...
                <td>@php $profit = $posts['total_selling_price'] - ($posts['quantity'] * $posts['unit_buying_price'] ); 
...
@foreach($piechartallsales as $piechart)
...
@foreach($lossmonthly as $piechart2)
...
<canvas id="barchartid" style="width:50%;max-width:600px"></canvas>-->
         ...
         <div class="card card-info">
              <div class="card-header">
                <h3 class="card-title">All Sales Quantity </h3>
        ...
        <canvas id="myChart" style="width:50%;max-width:600px"></canvas>     
          ...
          <div class="card card-success">
              <div class="card-header">
                <h3 class="card-title">All Sales Profit</h3>
         ...
         <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">All Loss</h3>
