     ...
     <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-info">
              <div class="inner">
                  ...
                  @php $total_capital= $total_capital + $mypost['endbalance']; @endphp
                  
                  @endforeach
                 
                <h3>@php echo number_format($total_capital,2); @endphp</h3>

                <p>Total Capital in ETB</p>
              </div>
              <div class="icon">	
            ...
            <div class="small-box bg-warning">
              <div class="inner">
                ...
                <h3>@php echo number_format($itemtype); @endphp</h3>

                <p>Total Items Type</p>
              </div>
              <div class="icon">
                <i class="fas fa-shopping-cart"></i>
              </div>
