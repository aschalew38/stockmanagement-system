  ...
  data-show-columns="true">
    ...
    <tr>
      ...
      <th  data-field="middlename" data-filter-control="input"  data-align="center" data-sortable="true" >Quantity</th>
        <th  data-field="amount" data-filter-control="input" data-align="center" data-sortable="true" >Unit Buying Price</th>
    ...
    <!--  <td>{{$posts['location']}}</td>-->
      <td>{{$posts['created_at']}}</td>
             <td><a href={{"update-stock-admin/".$posts['id']}}><button type="button" class="btn btn-primary btn-sm">Update</button></a></td>
   <td><a href={{"delete-stock-admin/".$posts['id']}}><button type="button" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure you want to delete this stock?');">
                Delete</button></a></td>
