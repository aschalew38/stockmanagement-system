  ...
  data-show-columns="true">
    ...
    @foreach($post as $posts)
        <tr>
            ...
            <td>{{$posts['city']}}</td>
             <td><a href={{"update-supplier/".$posts['id']}}><button type="button" class="btn btn-primary btn-sm">Update</button></a></td>
   <td><a href={{"delete-supplier/".$posts['id']}}><button type="button" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure you want to delete this stock?');">
                Delete</button></a></td>
