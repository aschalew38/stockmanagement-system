@include('adminheader')
 ...
 <section class="content">
    ...
    <h1> Debit Stock List(የተበደርከው)</h1>
  ...
  data-show-columns="true">
    ...
    <tr>
      ...
      <th  data-field="middlename" data-filter-control="input"  data-align="center" data-sortable="true" >Quantity</th>
        <th  data-field="amount" data-filter-control="input" data-align="center" data-sortable="true" >Unit Price</th>
             <th  data-field="amount" data-filter-control="input" data-align="center" data-sortable="true" >Total Price</th>
        <th  data-field="parentphone"data-filter-control="input"  data-align="center" data-sortable="true" >Supplier FullName</th>   
           <th  data-field="parentphone"data-filter-control="input"  data-align="center" data-sortable="true" >Purchase Type</th>
              ...
              <td>{{$posts['price'] * $posts['quantity']}}</td>
                <td>{{$posts['supplier_fullname']}}</td>
                  ...
                  <td>{{$posts['created_at']}}</td>  
                   <td>{{$posts['debit_return_date']}}</td>
             <td><a href={{"update-debit-admin/".$posts['id']}}><button type="button" class="btn btn-primary btn-sm" 
