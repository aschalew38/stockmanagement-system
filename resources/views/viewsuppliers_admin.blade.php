...
<table id="table"  class="table table-striped table-dark table-hover" 
  ...
  data-show-columns="true">
    ...
    <tr>
      ...
      <th  data-field="middlename" data-filter-control="input"  data-align="center" data-sortable="true" >Product</th>
    ...
    @foreach($post as $posts)
        <tr>
            ...
            <td>{{$posts['city']}}</td>
             <td><a href={{"update-supplier-admin/".$posts['id']}}><button type="button" class="btn btn-primary btn-sm">Update</button></a></td>
   <td><a href={{"delete-supplier-admin/".$posts['id']}}><button type="button" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure you want to delete this stock?');">
                Delete</button></a></td>
