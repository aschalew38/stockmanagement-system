...
<table id="table"  class="table table-striped table-dark table-hover" 
  ...
  data-show-columns="true">
    ...
    <tr>
      ...
      <th  data-field="middlename" data-filter-control="input"  data-align="center" data-sortable="true" >Middle Name</th>
        <th  data-field="amount" data-filter-control="input" data-align="center" data-sortable="true" >PhoneNumber</th>
        <th  data-field="lastname" data-filter-control="input"  data-align="center" data-sortable="true" >Role</th>
        <th  data-field="lastname" data-filter-control="input"  data-align="center" data-sortable="true" >Email</th>
       <!-- <th  data-field="lastname" data-filter-control="input"  data-align="center" data-sortable="true" >Password</th>-->
        <th >Update</th> 
         <th>Delete</th>  
    ...
    @foreach($post as $posts)
        <tr>
          ...
          <!--      <td>{{$posts['password']}}</td>-->
             <td><a href={{"update-account-admin/".$posts['id']}}><button type="button" class="btn btn-primary btn-sm">Update</button></a></td>
   <td><a href={{"delete-account-admin/".$posts['id']}}><button type="button" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure you want to delete this stock?');">
                Delete</button></a></td>
