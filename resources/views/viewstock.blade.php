      ...
      <th  data-field="middlename" data-filter-control="input"  data-align="center" data-sortable="true" >Quantity</th>
        ...
        <th  data-field="parentphone"data-filter-control="input"  data-align="center" data-sortable="true" >SupplierFullName</th>   
          <th  data-field="parentphone"data-filter-control="input"  data-align="center" data-sortable="true" >PurchaseType</th>
           ...
           <th  data-field="parentphone"data-filter-control="input"  data-align="center" data-sortable="true" >Store Name</th>
...
<!--</th>-->
  <!--      <th >Update</th> 
    ...
    <!--         <td><a href={{"update-stock/".$posts['id']}}><button type="button" class="btn btn-primary btn-sm">Update</button></a></td>
   <td><a href={{"delete-stock/".$posts['id']}}><button type="button" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure you want to delete this stock?');">
                Delete</button></a></td>-->

        </tr>
        @elseif(($posts->endquantity/$posts->quantity)>0 && ($posts->endquantity/$posts->quantity) < 0.3)
        <tr class="bg-warning">
