...
@foreach($piechartdaily as $piechart)
...
@foreach($lossdaily as $piechart2)
...
@endforeach
         ...
         <div class="card card-info">
              <div class="card-header">
                <h3 class="card-title">Daily Sales Quantity </h3>
        ...
        <canvas id="myChart" style="width:50%;max-width:600px"></canvas>     
          ...
          <div class="card card-success">
              <div class="card-header">
                <h3 class="card-title">Daily Sales Profit</h3>
         ...
         <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Daily Loss</h3>
