...
<table id="table"  class="table table-striped table-dark table-hover" 
  ...
  data-show-columns="true">
    ...
    <tr>
        ...
        <th data-field="firstname" data-filter-control="input" data-sortable="true" >StockID</th>
      ...
      <th  data-field="middlename" data-filter-control="input"  data-align="center" data-sortable="true" >Quantity</th>
        ...
        <th  data-field="parentphone"data-filter-control="input"  data-align="center" data-sortable="true" >Status</th>
   ...
   @endphp 
    ...
    @foreach($post as $posts)    
       ...
       <!--      <td><input type="hidden" name="id@php$num@endphp" value"{{$posts['id']}}">{{$posts['id']}}</td>-->
             <td><input type="hidden" name="stockname" value"{{$posts['stock_id']}}">{{$posts['stock_id']}}</td>
            ...
            <td><input type="hidden" name="price" value"{{$posts['price']}}">{{$posts['price']}}</td>
              <td><input type="hidden" name="printed" value"{{$posts['printed']}}">{{$posts['printed']}}</td>
                <td><input type="hidden" name="printed" value"{{$posts['printed']}}">{{$posts['status']}}</td>
