...
<body>
          ...
          <div class="col-md-8">
            <div class="card card-primary">
              <div class="card-header">
                ...
                <h6 class="card-title float-left">Unit Buying Price: {{ $post['price'] }}</h6>
  ...
  <input type="text" class="form-control" name="buyerphone"   placeholder="የገዥ  ስልክ ቁጥር">
            ...
            @endif
				  ...
				  <div class="col-sm-8">
				    <div class="form-group">
				      <input type="text" class="form-control"  id="returndate" name="returndate" placeholder=""  value=" @php echo date('Y-m-d'); @endphp "> 
				    </div>  
				     </div>
                </div>
				  <div class="row">
