        ...
        <!-- Small boxes (Stat box) -->
          ...
          <div class="col-md-8">
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form  action="{{route('update_supplier_save_admin')}}" method="post" name="form1">
                      {{ csrf_field() }}
                <div class="card-body">
				...
				<div class="col-sm-8">	
					   <div class="form-group">
                 <input type="text" class="form-control" id="suppliername" name="suppliername" placeholder="supplier full name" value="{{ $post['fullname'] }}" >
				...
				<div class="col-sm-2">
                  <div class="form-group">
                      <label>Product</label>
					    ...
					    <div class="col-sm-8">
						<div class="form-group">
                      <input type="text" class="form-control" name="product" placeholder="product" value="{{ $post['product'] }}">
