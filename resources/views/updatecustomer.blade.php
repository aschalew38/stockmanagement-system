        ...
        <!-- Small boxes (Stat box) -->
          ...
          <div class="col-md-8">
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form  action="{{route('update_customer_save')}}" method="post" name="form1">
                      {{ csrf_field() }}
                <div class="card-body">
				...
				<div class="col-sm-8">	
					   <div class="form-group">
                 <input type="text" class="form-control" id="customername" name="customername" placeholder="customer full name" value="{{ $post['fullname'] }}" >
